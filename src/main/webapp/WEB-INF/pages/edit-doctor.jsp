...
<h1 class="title">Edit Doctor Details</h1>
...
<div class="container d-flex justify-content-center align-items-center" style="height: 80vh;">
    ...
    <frm:form modelAttribute="doctorVO" class="form-box col-md-4">
        ...
        <div class="mb-3">
            ...
            <frm:input path="doctorId" readonly="true" class="form-control"/>
        </div>
        ...
        <div class="d-flex justify-content-between mt-4">
            <input type="submit" value="Update" class="btn btn-info text-white btn-custom">
